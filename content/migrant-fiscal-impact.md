...
New Zealand's Long-Term Fiscal Statement (LTFS) projects the Crown's fiscal position several decades forward. Its central finding, consistent across successive statements, is that population ageing will push net debt onto an unsustainable trajectory unless policy settings change. The mechanics are well understood: a larger share of the population above 65 means more superannuation and health expenditure, funded by a smaller share of working-age taxpayers. What the LTFS has historically been less precise about is how migration interacts with that trajectory. Migration is treated primarily as a demographic assumption — an annual net inflow that shapes the age structure — rather than as a first-order fiscal variable in its own right.

This matters because migration is now large relative to the domestic tax base. Hughes (2026) shows that foreign-born residents paid 38% of personal income tax in 2024, against a 32% share of the taxpaying population. The foreign-born are no longer a small correction to a domestic story; they are a structural feature of the Crown's revenue base. Yet the lifecycle fiscal impact of a marginal migrant — the present value of taxes they will pay less the public services they will draw — has never been estimated for New Zealand. Australia's Treasury produced such an estimate using linked administrative data (Varela et al., 2021); the equivalent gap for New Zealand is the motivation for this paper.

This paper does not close that gap. It takes a deliberate shortcut: combining two publicly released Treasury datasets to produce a first estimate, using summary statistics rather than linked microdata from the Integrated Data Infrastructure. Hughes (2026) provides migrant-specific tax data by visa type, age, nationality, and cohort retention. Wright and Nguyen (2024) provides the corresponding fiscal incidence framework — revenue and expenditure by age, including NZ Superannuation, health, education, and welfare. The combination is sufficient to produce defensible lifecycle NPV estimates and, through a synthetic population extension, their distributions within migrant groups.

What the paper does not attempt is as important as what it does. It is not a microsimulation. It is not causal. It does not capture second-round effects on housing, infrastructure, or wages. It relies on population-average expenditure profiles, adjusted for known eligibility restrictions rather than migrant-specific spending data. Its purpose is to demonstrate feasibility: to show that meaningful lifecycle fiscal estimates are derivable from existing public data, and to motivate a full lifecycle model using the IDI that Treasury is well placed to commission.
...
This widening gap reflects both volume and value effects. The number of foreign-born taxpayers grew from 909,000 in 2000 to 1.61 million in 2024 — a 77% increase, compared with 17% growth in NZ-born taxpayers over the same period (2.94 million to 3.44 million). But per-capita contributions also shifted. In 2000, foreign-born and NZ-born taxpayers paid similar per-person tax: $3,900 and $3,800 respectively. By 2024, the foreign-born average had reached $12,500, compared with $9,700 for the NZ-born — a 29% premium per person (Hughes Table 4). A Shapley decomposition of the 13.5 percentage point increase in the foreign-born tax share (from 24.1% in 2000 to 37.6% in 2024) attributes 8.75 percentage points (65%) to the volume effect — the faster growth of the foreign-born taxpayer count relative to the NZ-born — and 4.79 percentage points (35%) to the value effect — the opening of a per-capita tax premium where none existed in 2000. The volume effect is therefore the larger of the two contributions, though both are material.
...
Chinese migrants at age 30 show an estimated lifecycle contribution of $47,000, below the NZ-born benchmark of $72,000 (NPV model output). **This estimate uses 2019 tax data as the matching year** (see Section 2.2) to align with Wright and Nguyen's 2018/19 fiscal incidence framework, and so it predates the convergence described in the preceding paragraphs. In 2019, Chinese migrants aged 30 paid meaningfully less tax per person than the NZ-born; in 2024, they pay 17% more. The convergence ratios in this section draw on 2024 data to tell the integration story, while the NPV model uses 2019 data to match the expenditure template. A model rebuilt on 2024 tax data would yield a materially higher Chinese NPV — likely crossing the NZ-born benchmark — and the point estimate here should be read as a lower bound reflecting an earlier cohort's earnings profile, not as a current assessment. Static point-in-time models systematically understate the fiscal contribution of nationality groups on an upward earnings trajectory. Section 7 combines these visa- and nationality-specific tax patterns with retention probabilities into lifecycle NPV estimates.
...
The household-level figures below are **year-of-arrival snapshots**, not lifecycle NPVs. They answer a different question from the NPV estimates in Section 7.1: not "what does a skilled migrant contribute over their expected New Zealand lifetime?" but "what is the annual net fiscal balance of a complete family unit in the first year after arrival?" The two questions have different answers because most household fiscal costs in year one are education and health spending on children — costs that peak early and decline as children age into working life, while the children's future tax contributions lie decades in the future and are heavily discounted in lifecycle NPV terms.

With that framing, the annual snapshot is this. A representative skilled migrant family — primary applicant earning $53,000 per year, non-earning spouse, and three dependent children — has an estimated net fiscal cost of $68,400 in the year of arrival, driven by education and health expenditure on children at approximately $21,400 per child per year (synthetic population output). The primary applicant considered in isolation is a net contributor of approximately $2,500 per year; it is the dependants who tip the annual household balance to a net cost. An NZ-born family of comparable composition carries an annual net cost of $58,600 — lower than the migrant family figure, but only because the NZ-born family is not generating the $9,800 annual tax premium a skilled primary applicant provides. A working holiday couple with no dependants shows a combined annual net contribution of $5,700.

**These annual figures do not contradict the lifecycle NPV results.** The skilled primary applicant's $132,100 lifecycle contribution is calculated on the individual — primary applicant only — across 55 years with retention weighting. The household's annual $68,400 cost is calculated on four or five people at a single point in time, with the primary applicant's working life still ahead of them. A household lifecycle NPV would require tracking each family member's fiscal trajectory independently — including children ageing into working years, spouses entering the labour force, and cohort-specific retention — which is beyond the scope of this summary-level analysis. The appropriate interpretation of the household snapshot is as a reminder that primary applicant estimates are not family-unit estimates, not as a refutation of the lifecycle surplus shown above.
